...
開源為練習領導及管理的能力提供了很好的機會。例如如何解決衝突、組織團隊以及如何為
工作的優先順序排列。
...
不用擔心！條條大路通羅馬，有很多能參與開源專案的方式。以下是一些實用的技巧，幫�
快速的獲得經驗。

### **你不一定要會寫程式才能貢獻**

對開源做出貢獻常見的誤解之一就是：要寫程式纔算貢獻。其實專案裡不需編碼的工作也
是[經常被忽視](https://github.com/blog/2195-the-shape-of-open-source)的部分。�
...
很多開源專案還是都遵循著組織架構的。嘗試認識不同社群角色和整體流程，能幫助你在�
入一個新的專案時快速的找到你的定位。
...
一個較大的專案，可能底下還會細分子社群，或是針對不同任務組成的工作小組，比如負責
...
無論你只是一次性的貢獻，或是決定長期參與社群，在開源的世界裡，學會如何與他人共事
是很重要的技能之一。
...
做，除非是你要分享一些機敏資訊（諸如安全問題或有人嚴重的違反行為準則）。你若能�
...
如果你沒有找到和你想法一樣的內容，你就可以開工了。如果專案是在 GitHub 上的話，�
可以開啓一個 issue 或 PR：
...
- **和專案現有的風格保持一致**，盡你最大的努力，在使用縮排、分號或註釋很可能和�
...
如果過了一週，依舊沒有人回應，請心平氣和的在同個條目下留言，請人幫你審核。如果�
...
收，這正是一個很好的機會，去詢問維護者的看法、給他們一個澄清的機會。無論如何，�
